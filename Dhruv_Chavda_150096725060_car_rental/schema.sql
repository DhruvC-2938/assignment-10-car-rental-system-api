-- Supabase PostgreSQL Schema for Car Rental & Fleet Management System
...
-- 3. Indexes for faster search & collision check
CREATE INDEX IF NOT EXISTS idx_rentals_dates ON rentals (vehicle_id, start_date, end_date, status);
